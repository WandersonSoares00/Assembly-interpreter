...
long int* get_firmware (){
        ...
        firmware[3]  =  0b000000000'000'00010100'010000'100'011'000'011;
        /*      Instrução 5   ->  if X = 0 then goto address */
        firmware[4]  =  0b000000101'001'00010100'000100'000'000'000'011;
        firmware[5]  =  0b000000000'000'00110101'001000'000'000'000'001;
        firmware[261] = 0b001100100'000'00000000'000000'000'000'000'000;
        /*      Instrução 6  ->  X = X - mem[address]    */
        firmware[6]  =  0b000000000'000'00111111'000100'000'011'000'011;
        /*      Instrução 7  ->  X = X * mem[address]    */
        firmware[7]  =  0b000000000'000'00001100'000100'000'011'000'011;
        /*      Instrução 8  ->  X = X / mem[address]    */
        firmware[8]  =  0b000000000'000'00011100'000100'000'011'000'011;
        /*      Instrução 9  ->  X = mem[address]    */
        firmware[9]  =  0b000000000'000'00010100'000100'100'011'000'000;


        /*      Instrução 2  ->  Y = Y + mem[address]   */
        firmware[18] =   0b000000000'000'00111100'000010'000'011'000'100;
        /*      Instrução 3    ->  mem[address] = Y  */
        firmware[19]  =  0b000000000'000'00010100'010000'100'011'000'100;
        /*      Instrução 5   ->  if Y = 0 then goto address */
        firmware[20]  =  0b000010101'001'00010100'000010'000'000'000'100;
        firmware[21]  =  0b000000000'000'00110101'001000'000'000'000'001;
        firmware[277] =  0b001100100'000'00000000'000000'000'000'000'000;
        /*      Instrução 6  ->  Y = Y - mem[address]    */
        firmware[22]  =  0b000000000'000'00111111'000010'000'011'000'100;
        /*      Instrução 7  ->  Y = Y * mem[address]    */
        firmware[23]  =  0b000000000'000'00001100'000010'000'011'000'100;
        /*      Instrução 8  ->  Y = Y / mem[address]    */
        firmware[24]  =  0b000000000'000'00011100'000010'000'011'000'100;
        /*      Instrução 9  ->  Y = mem[address]    */
        firmware[25]  =  0b000000000'000'00010100'000010'100'011'000'000;
