...
unsigned long int* get_firmware (){
        ...
        firmware[1] = 0b000000010'000'00010100'000001'000'000; // bus_b = mdr, bus_a = bus_b

        firmware[2] = 0b000000011'000'00110001'100000'010'111; // mar = 1, mdr = men[mar]
        firmware[3] = 0b000000100'000'00110101'100000'000'011; // bus_b = x, ++bus_b, mar = bus_b (mar = 3)
        
                                                               // bus_b = mdr, bus_c = bus_b(mdr) + bus_a
        firmware[4] = 0b111111111'000'00111100'010000'100'000; // mdr = bus_c, men[3] = mdr, halt
