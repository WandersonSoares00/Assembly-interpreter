...
long int* get_firmware (){
        ...
        firmware[0] =   0b000000000'100'00000000'000000'000'001'101'000;
        ...
        firmware[2] =   0b000000011'000'00010100'000001'000'011'101'000;
        firmware[3] =   0b000000000'000'00111100'000100'000'000'101'011;
        ...
        firmware[6]  =  0b000000000'000'00010100'010000'100'011'101'011;

        /*      Instrução 4    ->  goto address    */
        //  9: PC <- PC + 1; fetch; GOTO 10
        //  10: PC <- MBR; fetch; GOTO MBR
        firmware[9]  =  0b000001010'000'00000000'000000'000'001'101'000;
        firmware[10] =  0b000000000'100'00010100'001000'001'000'101'010;
        ...
        // 268: GOTO 9
        firmware[11]  =  0b000001100'001'00010100'000100'000'000'101'011;
        firmware[12]  =  0b000000000'000'00110101'001000'000'000'101'001;
        firmware[268] =  0b000001001'000'00000000'000000'000'000'101'000;
        ...
        //  15: H <- MDR; goto 16
        //  16: X <- X - H; goto 0
        firmware[13]  =  0b000001110'000'00010100'000001'000'011'101'000;
        firmware[14]  =  0b000000000'000'00111111'000100'000'000'101'011;
        ...
        //  19: H <- MDR; goto 20
        //  20: X <- X * H; goto 0
        firmware[17]  =  0b000010010'000'00010100'000001'000'011'101'000;
        firmware[18]  =  0b000000000'000'00001100'000100'000'000'101'011;
        ...
        //  19: H <- MDR; goto 23
        //  20: X <- X / H; goto 0
        firmware[21]  =  0b000010110'000'00010100'000001'000'011'101'000;
        firmware[22]  =  0b000000000'000'00011100'000100'000'000'101'011;
        ...
        firmware[25]  =  0b000000000'000'00010100'000100'100'011'101'000;
